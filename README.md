...
| **AI Foundry Projects** | Individual project workspaces | SystemAssigned managed identity |
| **Azure AI Services** | OpenAI models & cognitive services | SystemAssigned managed identity, AAD auth |
| **Key Vault** | Secret/key management | RBAC, soft-delete, purge protection |
| **Storage Account** | Model/data storage | No public access, HTTPS only, TLS 1.2+ |
